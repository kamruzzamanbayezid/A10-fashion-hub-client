            ...
            <div>
                  <div className="carousel w-full">
                        <div id="slide1" className="carousel-item relative w-full">
                              <img src="https://i.ibb.co/z7X9G93/04b166b298bb1f4eee3505c0eb60ff18.jpg" className="w-full h-[70vh]" />
                        ...
                        <div id="slide2" className="carousel-item relative w-full h-[70vh]">
                              <img src="https://i.ibb.co/5hYvWYh/adidas-spark-messi.webp" className="w-full" />
                              <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        ...
                        <div id="slide3" className="carousel-item relative w-full h-[70vh]">
                              <img src="https://i.ibb.co/prh8cNZ/922c67eddb0ef6d69b775d784dcb40cf.jpg" className="w-full" />
                              <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                                    <a href="#slide2" className="btn btn-circle">❮</a>
                                    <a href="#slide1" className="btn btn-circle">❯</a>
                              </div>
